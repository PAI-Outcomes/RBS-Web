...
my $pharmacy_string;
my $db_rbs     = 'rbsreporting';
my $tbl_cnames = 'consolidated_names';
my $cname;
my $ptype;
$nbsp = "&nbsp\;";
...
($RptType)    = &StripJunk($RptType);
($Submit)     = &StripJunk($Submit);
...
#($suNCPDPs,$ptype) = &getsuperuserncpdps($USER);
($suPH_IDs,$ptype) = &get_user_pharmacyids($USER);
print "$suPH_IDs\n";

my @suPH_IDs = split(',',$suPH_IDs);
&get_consolidated_names;

foreach $Pharmacy_ID (@suPH_IDs) {
  $inNCPDP = $Pharmacy_NCPDPs{$Pharmacy_ID};
...
&displayGrossMargin;
if ($jmonth =~ /3|6|9|12/) {
  &displayGrossMarginQTR;
}

&displayGrossMarginPercent;

&displayAverageSalePerScript;

&displayAverageGrossMarginPerScript;
...
print "<hr>TOP- ReportMonth: $ReportMonth<hr>\n" if ($debug);
...
sub displayReportHeader {
  ...
  print qq#<h1 class="rbsreporting">$RptType Report - $ReportMonthDisplay</h1>\n#;

#  print qq#<table class="header">\n#;
#  print qq#<tr>\n#;
#  print qq#<td class="logo"><img src="/images/pa_rbs_logo.png" style="width: 100%; max-width: 400px;"></td>\n#;
#  print qq#<td>$RptType Report<br>$ReportMonthDisplay</td>\n#;

  $pharmacy_string = "$cname\n";

#  print qq#<div>$pharmacy_string</div>\n#;
#  print qq#<td>$pharmacy_string</td>\n#;

#  print qq#<td class="noprint">\n#;
#  $URLH = "$progext";
#  print qq#<FORM ACTION="$URLH" METHOD="POST">\n#;
#  print qq#<INPUT TYPE="hidden" NAME="RptType"    VALUE="$RptType">\n#;
...
sub displayScriptCount {
  ...
  for (my $lyear=$yearm2; $lyear<=$yearcur; $lyear++) {
    for (my $lmonth=1; $lmonth<=12; $lmonth++) {
      ...
      foreach $Pharmacy_ID (@suPH_IDs) { 
        $inNCPDP = $Pharmacy_NCPDPs{$Pharmacy_ID}; 
        $RepKey = "$inNCPDP##$lyear-$lmonth-01"; 
        $DataLoadKey = "$lyear##$lmonth";      
        $Brand_Scripts;
        $Generic_Scripts;
        $Total_Scripts;
    
        $Brand_Scripts   = $Rep_Total_Brand{$RepKey} || 0;
        $Generic_Scripts = $Rep_Total_Generic{$RepKey} || 0;
        $Total_Scripts   = ($Brand_Scripts + $Generic_Scripts) || 0;
#        print "REPKEY: $RepKey - $DataLoadKey, BRAND: $Brand_Scripts<br>";
  ...
  my $section_title = "Script Count - $pharmacy_string";
...
sub displayScriptCountQTR {
  ...
  ###---###---###---###---###---###---###---###---###---###---###---###---###---###---###---###
  $section_title = "Script Information by QTR - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
...
sub displaySales {
  ...
  for (my $lyear=$yearm2; $lyear<=$yearcur; $lyear++) {
    for (my $lmonth=1; $lmonth<=12; $lmonth++) {
      ...
      foreach $Pharmacy_ID (@suPH_IDs) { 
        ...
        $Brand_Sales   += $Rep_Total_Brand_Revenue{$RepKey} || 0;
        $Generic_Sales += $Rep_Total_Generic_Revenue{$RepKey} || 0;
      }
      $Total_Sales   += ($Brand_Sales + $Generic_Sales) || 0;
  ...
  ###---###---###---###---###---###---###---###---###---###---###---###---###---###---###---###
  my $section_title = "Sales - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
...
sub displaySalesQTR {
  ...
  for (my $lyear=$yearm2; $lyear<=$yearcur; $lyear++) {
    for (my $lqtr=1; $lqtr<=4; $lqtr++) {
      ...
      foreach $Pharmacy_ID (@suPH_IDs) { 
        ...
        $Brand_Sales   += $Rep_Total_Brand_Revenue{$QtrRepKey} || 0;
        $Generic_Sales += $Rep_Total_Generic_Revenue{$QtrRepKey} || 0;
      }
      $Total_Sales   += ($Brand_Sales + $Generic_Sales) || 0;
  ...
  ###---###---###---###---###---###---###---###---###---###---###---###---###---###---###---###
  $section_title = "Sales by QTR - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
...
sub displayGrossMargin {
  ...
  for (my $lyear=$yearm2; $lyear<=$yearcur; $lyear++) {
    for (my $lmonth=1; $lmonth<=12; $lmonth++) {
      ...
      foreach $Pharmacy_ID (@suPH_IDs) { 
        ...
        $Brand_GM   += $Rep_Total_Brand_Revenue{$RepKey} - $Rep_Total_Brand_Cost{$RepKey};
        $Generic_GM += $Rep_Total_Generic_Revenue{$RepKey} - $Rep_Total_Generic_Cost{$RepKey};
        $Total_GM   += ( 
  ...
  ###---###---###---###---###---###---###---###---###---###---###---###---###---###---###---###
  my $section_title = "Gross Margin - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
...
sub displayGrossMarginQTR {
  ...
  for (my $lyear=$yearm2; $lyear<=$yearcur; $lyear++) {
    for (my $lqtr=1; $lqtr<=4; $lqtr++) {
      ...
      foreach $Pharmacy_ID (@suPH_IDs) { 
        $inNCPDP = $Pharmacy_NCPDPs{$Pharmacy_ID}; 
        my $QtrRepKey  = "$inNCPDP##$lyear##Q$lqtr"; #Build key to retrieve data
        $Brand_GM   += $Rep_Total_Brand_Revenue{$QtrRepKey} - $Rep_Total_Brand_Cost{$QtrRepKey};
        $Generic_GM += $Rep_Total_Generic_Revenue{$QtrRepKey} - $Rep_Total_Generic_Cost{$QtrRepKey};
        $Total_GM   += ( 
  ...
  ###---###---###---###---###---###---###---###---###---###---###---###---###---###---###---###
  my $section_title = "Gross Margin by QTR - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
...
sub displayGrossMarginPercent {
  ...
  my $Total_Brand_Rev    = 0;
  my $Total_Brand_Cost   = 0;
  my $Total_Generic_Rev  = 0;
  my $Total_Generic_Cost = 0;
  my $Total_Rev          = 0;
  my $Total_Cost         = 0;
    ...
    for (my $lmonth=1; $lmonth<=12; $lmonth++) {
      ...
      foreach $Pharmacy_ID (@suPH_IDs) { 
        ...
        if ($Rep_Total_Brand_Revenue{$RepKey} > 0) {
          $Total_Brand_Rev += $Rep_Total_Brand_Revenue{$RepKey};
        }
        if ($Rep_Total_Brand_Cost{$RepKey} > 0) {
          $Total_Brand_Cost += $Rep_Total_Brand_Cost{$RepKey};
        }

        if ($Rep_Total_Generic_Revenue{$RepKey} > 0) {
          $Total_Generic_Rev += $Rep_Total_Generic_Revenue{$RepKey};
        }
        if ($Rep_Total_Generic_Cost{$RepKey} > 0) {
          $Total_Generic_Cost += $Rep_Total_Generic_Cost{$RepKey};
        }
      }

      if ($Total_Brand_Rev > 0) {
        $Brand_GM_Percent   = ($Total_Brand_Rev - $Total_Brand_Cost) / $Total_Brand_Rev;
      }
      if ($Total_Generic_Rev > 0) {
        $Generic_GM_Percent = ($Total_Generic_Rev - $Total_Generic_Cost) / $Total_Generic_Rev;
      }

      if ( ($Total_Brand_Rev + $Total_Generic_Rev) > 0) {
          $Total_GM_Percent  = ($Total_Brand_Rev + $Total_Generic_Rev - $Total_Brand_Cost - $Total_Generic_Cost) / ( $Total_Brand_Rev + $Total_Generic_Rev);
      }
  ...
  ###---###---###---###---###---###---###---###---###---###---###---###---###---###---###---###
  my $section_title = "Gross Margin Percent - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
...
sub displayAverageSalePerScript {
  ...
  my $Total_Brand_Revenue              = 0;
  my $Total_Generic_Revenue            = 0;
  my $Total_Generic                    = 0;
  my $Total_Brand                      = 0;
  ...
  for (my $lyear=$yearm2; $lyear<=$yearcur; $lyear++) {
    for (my $lmonth=1; $lmonth<=12; $lmonth++) {
      ...
      $lmonth = sprintf("%02d", $lmonth);
      my $DataLoadKey = "$lyear##$lmonth";        #Build key to send data to graph
      $Brand_Avg_Sale_Per_Script        = 0;
      $Generic_Avg_Sale_Per_Script      = 0;
      $Total_Avg_Sale_Per_Script        = 0;
      $Total_Brand_Revenue              = 0;
      $Total_Generic_Revenue            = 0;
      $Total_Generic                    = 0;
      $Total_Brand                      = 0;
      ...
      foreach $Pharmacy_ID (@suPH_IDs) { 
        ...
        $Total_Brand_Revenue   += $Rep_Total_Brand_Revenue{$RepKey};
        $Total_Brand           += $Rep_Total_Brand{$RepKey} ;
        $Total_Generic_Revenue += $Rep_Total_Generic_Revenue{$RepKey};
        $Total_Generic         += $Rep_Total_Generic{$RepKey};
        
      }

      if ($Total_Brand > 0) {
        $Brand_Avg_Sale_Per_Script   = $Total_Brand_Revenue / $Total_Brand;
      }
      if ($Total_Generic > 0) {
        $Generic_Avg_Sale_Per_Script = $Total_Generic_Revenue / $Total_Generic;
      }
      if ($Total_Brand + $Total_Generic > 0) {
        $Total_Avg_Sale_Per_Script   =  ($Total_Brand_Revenue + $Total_Generic_Revenue) /  ($Total_Brand + $Total_Generic);
      }
  ...
  ###---###---###---###---###---###---###---###---###---###---###---###---###---###---###---###
  my $section_title = "Average Sale Per Script - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
...
sub displayAverageGrossMarginPerScript {
  ...
  for (my $lyear=$yearm2; $lyear<=$yearcur; $lyear++) {
    for (my $lmonth=1; $lmonth<=12; $lmonth++) {
      ...
      $lmonth = sprintf("%02d", $lmonth);
      my $DataLoadKey = "$lyear##$lmonth";        #Build key to send data to graph
      $Generic_Avg_Gross_Margin_Per_Script      = 0;
      $Total_Avg_Gross_Margin_Per_Script        = 0;
      $Total_Brand_Revenue                      = 0;
      $Total_Brand                              = 0;
      $Total_Generic_Revenue                    = 0;
      $Total_Generic                            = 0;
      ...
      if ($Total_Brand > 0) {
        $Brand_Avg_Gross_Margin_Per_Script   = ($Total_Brand_Revenue - $Total_Brand_Cost) / $Total_Brand;
      }
      if ($Total_Generic > 0) {
        $Generic_Avg_Gross_Margin_Per_Script = ($Total_Generic_Revenue - $Total_Generic_Cost) / $Total_Generic;
      }
      if (($Total_Brand + $Total_Generic) > 0) {
        $Total_Avg_Gross_Margin_Per_Script   = ($Total_Brand_Revenue + $Total_Generic_Revenue - $Total_Brand_Cost - $Total_Generic_Cost) / ($Total_Brand + $Total_Generic);
      }
  ...
  ###---###---###---###---###---###---###---###---###---###---###---###---###---###---###---###
  my $section_title = "Average Gross Margin Per Script - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
...
sub SalesByPayer {
  ...
  SELECT ncpdp FROM rbsreporting.sales_by_payer_new WHERE Pharmacy_ID IN ($suPH_IDs) && Year = $jyear && Qtr_YTD = $jqtr";
  ...
  if ($sbp_data_present > 0) {
    print qq#<div class="page">#;
    print qq#<div class="page_header"><h3>Sales by Payer - $pharmacy_string</h3></div><br />#;
  
    print "<p>Database data present!</p>" if ($debug);
    
    if      ( $jqtr == 1 ) {
      $timeframe     = "date >= '${yearcur}-01-01' && date <= '${yearcur}-03-31' ";
    $timeframehist = "date >= '${yearm1}-01-01'  && date <= '${yearm1}-03-31' ";
    } elsif ( $jqtr == 2 ) {
      $timeframe     = "date >= '${yearcur}-01-01' && date <= '${yearcur}-06-30' ";
    $timeframehist = "date >= '${yearm1}-01-01'  && date <= '${yearm1}-06-30' ";
    }  elsif ( $jqtr == 3 ) {
      $timeframe     = "date >= '${yearcur}-01-01' && date <= '${yearcur}-09-30' ";
    $timeframehist = "date >= '${yearm1}-01-01'  && date <= '${yearm1}-09-30' ";
    }  elsif ( $jqtr == 4 ) {
      $timeframe     = "date >= '${yearcur}-01-01' && date <= '${yearcur}-12-31' ";
    $timeframehist = "date >= '${yearm1}-01-01'  && date <= '${yearm1}-12-31' ";
    }  
    ...
    SELECT * FROM (
      SELECT * FROM (
        SELECT Plan, 
               sum(Brand_Count + Generic_Count) Count,
               sum(Generic_Count) Generic_Count,
               ROUND((( sum(Generic_Count) /sum(Generic_Count + Brand_Count))*100), 1) GDR_Percent,
               FORMAT(sum(Brand_Sale + Generic_Sale),0) Sales, 
               FORMAT(((sum(Brand_Sale + Generic_Sale) / 
                 (SELECT sum(Total_Brand_Revenue + Total_Generic_Revenue) 
                    FROM rbsreporting.monthly 
                   WHERE Pharmacy_ID IN ($suPH_IDs) && $timeframe
                 )
               )*100), 1) Percent, 

               FORMAT((sum(Brand_Sale + Generic_Sale) - (sum(Brand_Cost) + sum(Generic_Cost))), 0) GM, 
               FORMAT((((sum(Brand_Sale + Generic_Sale) - (sum(Brand_Cost) + sum(Generic_Cost)))/sum(Brand_Sale + Generic_Sale))*100), 1) GM_Percent, 
               FORMAT((sum(Brand_Sale + Generic_Sale) / sum(Brand_Count + Generic_Count)), 2) Sale_Per_Script, 
               FORMAT(((sum(Brand_Sale + Generic_Sale) - (sum(Brand_Cost) + sum(Generic_Cost))) / sum(Brand_Count + Generic_Count)), 2) GM_Per_Script, 
               FORMAT((sum(Days_Supply) / sum(Days_Supply_Count)), 1) Avg_Days_Supply 

          FROM rbsreporting.sales_by_payer_new 
         WHERE Pharmacy_ID IN ($suPH_IDs) && Year = $jyear && Qtr_YTD = $jqtr
  ...
  ##  print "Sales By Payer sql: $sqlout<br>\n";
    ...
    if ($SBPNumOfRows > 0) {
      ...
      print "<tr><th>Plan</th><th>Rx Count</th><th>GDR</th><th>Sales</th><th>% of Sales</th><th>Gross Margin</th><th>GM %</th><th>Sale/ Script</th><th>GM/ Script</th><th>Avg. Days Supply</th></tr>";
      while ( my @row = $getSBPdata->fetchrow_array() ) {
        ...
        print "<tr><td style=\"text-align: left;\">$plan</td><td>$count_disp</td><td>$gdr_percent%</td><td>\$$sales</td><td>$percent%</td><td>\$$gm</td><td>$gm_percent%</td><td>\$$sale_per_script</td><td>\$$gm_per_script</td><td>$avg_day_supply</td></tr>";
        $shown_count   += $count;
      ...
      SUM( 
      (CASE WHEN Rebate_Type = 'P' THEN (Total_Brand_Cost * (1 - Brand_Rebate)) ELSE (Total_Brand_Cost * (1 - (Brand_Rebate/Total_Brand_Cost))) END) + 
      (CASE WHEN Rebate_Type = 'P' THEN (Total_Generic_Cost * (1 - Generic_Rebate)) ELSE (Total_Generic_Cost * (1 - (Generic_Rebate/Total_Generic_Cost))) END)
      ) as Rebated_Cost,
      ...
      FROM ( 
      SELECT Pharmacy_ID, NCPDP, date, date_format(date, '%Y%m') as datef, Total_Brand_Revenue, Total_Generic_Revenue, Total_Brand_Cost, Total_Generic_Cost, Total_Brand, Total_Generic
      FROM rbsreporting.monthly 
      WHERE 
      Pharmacy_ID IN ($suPH_IDs) && $timeframe 
      ) pharm 
      LEFT JOIN rbsreporting.rebates rebates 
      ON (pharm.Pharmacy_ID = rebates.Pharmacy_ID && BINARY pharm.datef = BINARY YYYYMM)
      ;
      ";
      ...
      if ($NumOfRows > 0) {
        while ( my @row = $getTotalSales->fetchrow_array() ) {
          ...
          print "Total Rx Sales Amount: $total_rx_sales" if ($debug);
        }
      }
      ...
      if ( $SBPNumOfRows >= $showPlansMAX ) {
        #Other Row
        #print "<tr><td style=\"text-align: left;\">Other</td><td>$other_count</td><td>\$$other_total</td><td>$other_percent%</td><td>\$$other_gm</td><td>$other_gm_percent%</td><td>\$$other_sale_per_script</td><td>\$$other_gm_per_script</td><td>---</td></tr>";
      }
      ...
      #Total Row
      print "<tr><td style=\"text-align: left;\">Totals (YTD Q$jqtr)</td><td>$total_count</td><td>$total_gdr_percent%</td><td>\$$total_rx_sales</td><td>$total_percent%</td><td>\$$total_gm</td><td>$total_gm_percent%</td><td>\$$total_sale_per_script</td><td>\$$total_gm_per_script</td><td>---</td></tr>";
      ...
      FROM rbsreporting.monthly 
      WHERE 
      Pharmacy_ID IN ($suPH_IDs) && $timeframehist
      ) pharm 
      LEFT JOIN rbsreporting.rebates rebates 
      ON (pharm.Pharmacy_ID = rebates.Pharmacy_ID && BINARY pharm.datef = BINARY YYYYMM)
      ;
      ...
      #print $sql;
      #print "<p>$total_rx_sales_hist, $total_rx_cost_hist, $total_rx_count_hist</p>\n";
      ...
      #Total Row - Last Year
      print "<tr><td style=\"text-align: left;\">Prior Year (Q$jqtr)</td><td>$total_count_hist</td><td>$total_gdr_percent_hist%</td><td>\$$total_rx_sales_hist</td><td>---</td><td>\$$total_gm_hist</td><td>$total_gm_percent_hist%</td><td>\$$total_sale_per_script_hist</td><td>\$$total_gm_per_script_hist</td><td>---</td></tr>";  
...
";
   ...
   if ($rowsfound > 0) {
      ...
      while ( my @row = $checkData->fetchrow_array() ) {
         ...
         if ( $debug ) {
           ...
           print "<tr><th colspan=2>RowType = 'L' && NCPDP = $NCPDP</th></tr>\n";
           print "<tr><th width=65% align=left>Variable</th><th>Value</th>\n";
           print "<tr><td>A1- key                                </td><td> $NCPDP</td></tr>\n";
           print "<tr><td>B1- RowType                            </td><td> $RowType</td></tr>\n";
           print "<tr><td>C1- Pharmacy_Name                      </td><td> $Pharmacy_Name</td></tr>\n";
           print "<tr><td>D1- NCPDP                              </td><td> $NCPDP</td></tr>\n";
           print "<tr><td>E1- Pharmacy_Type                      </td><td> $Pharmacy_Type</td></tr>\n";
           print "<tr><td>F1- Location                           </td><td> $Location</td></tr>\n";
           print "<tr><td>G1- Size                               </td><td> $Size</td></tr>\n";
           print "<tr><td>H1- Total_Count                        </td><td> $Total_Count</td></tr>\n";
           print "<tr><td>I1- Brand_Count                        </td><td> $Brand_Count</td></tr>\n";
           print "<tr><td>J1- Generic_Count                      </td><td> $Generic_Count</td></tr>\n";
           print "<tr><td>K1- Total_Sale                         </td><td> $Total_Sale</td></tr>\n";
           print "<tr><td>L1- Brand_Sale                         </td><td> $Brand_Sale</td></tr>\n";
           print "<tr><td>M1- Generic_Sale                       </td><td> $Generic_Sale</td></tr>\n";
           print "<tr><td>N1- Total_GM                           </td><td> $Total_GM</td></tr>\n";
           print "<tr><td>O1- Brand_GM                           </td><td> $Brand_GM</td></tr>\n";
           print "<tr><td>P1- Generic_GM                         </td><td> $Generic_GM</td></tr>\n";
           print "<tr><td>Q1- Total_GM_Percent                   </td><td> $Total_GM_Percent</td></tr>\n";
           print "<tr><td>R1- Brand_GM_Percent                   </td><td> $Brand_GM_Percent</td></tr>\n";
           print "<tr><td>S1- Generic_GM_Percent                 </td><td> $Generic_GM_Percent</td></tr>\n";
           print "<tr><td>T1- Total_Sale_Per_Script              </td><td> $Total_Sale_Per_Script</td></tr>\n";
           print "<tr><td>U1- Brand_Sale_Per_Script              </td><td> $Brand_Sale_Per_Script</td></tr>\n";
           print "<tr><td>V1- Generic_Sale_Per_Script            </td><td> $Generic_Sale_Per_Script</td></tr>\n";
           print "<tr><td>W1- Total_GM_Per_Script                </td><td> $Total_GM_Per_Script</td></tr>\n";
           print "<tr><td>X1- Brand_GM_Per_Script                </td><td> $Brand_GM_Per_Script</td></tr>\n";
           print "<tr><td>Y1- Generic_GM_Per_Script              </td><td> $Generic_GM_Per_Script</td></tr>\n";
           print "<tr><td>Z1- Unique_Patients                    </td><td> $Unique_Patients</td></tr>\n";
           print "<tr><td>A2- Average_Unique_Patients            </td><td> $Average_Unique_Patients</td></tr>\n";
           print "<tr><td>B2- Average_Scripts_Per_Unique_Patient </td><td> $Average_Scripts_Per_Unique_Patient</td></tr>\n";
           print "<tr><td>C2- Average_Sale_Per_Unique_Patient    </td><td> $Average_Sale_Per_Unique_Patient</td></tr>\n";
           print "<tr><td>D2- Average_GM_Per_Unique_Patient      </td><td> $Average_GM_Per_Unique_Patient</td></tr>\n";
           print "<tr><td>E2- New_Claim_Count                    </td><td> $New_Claim_Count</td></tr>\n";
           print "<tr><td>F2- New_Claim_Sales                    </td><td> $New_Claim_Sales</td></tr>\n";
           print "<tr><td>G2- Refill_Claim_Count                 </td><td> $Refill_Claim_Count</td></tr>\n";
           print "<tr><td>H2- Refill_Claim_Sales                 </td><td> $Refill_Claim_Sales</td></tr>\n";
           print "<tr><td>I2- Controlled_Count_ALL               </td><td> $Controlled_Count_ALL</td></tr>\n";
           print "<tr><td>J2- Controlled_Count_ALL_Percent       </td><td> $Controlled_Count_ALL_Percent</td></tr>\n";
           print "<tr><td>K2- Controlled_Sale_ALL                </td><td> $Controlled_Sale_ALL</td></tr>\n";
           print "<tr><td>L2- Controlled_Sale_ALL_Percent        </td><td> $Controlled_Sale_ALL_Percent</td></tr>\n";
           print "<tr><td>M2- Legent_Count_ALL                   </td><td> $Legent_Count_ALL</td></tr>\n";
           print "<tr><td>N2- Legent_Count_ALL_Percent           </td><td> $Legent_Count_ALL_Percent</td></tr>\n";
           print "<tr><td>O2- Legend_Sale_ALL                    </td><td> $Legend_Sale_ALL</td></tr>\n";
           print "<tr><td>P2- Legend_Sale_ALL_Percent            </td><td> $Legend_Sale_ALL_Percent</td></tr>\n";
           print "<tr><td>Q2- Controlled_Count_CASH              </td><td> $Controlled_Count_CASH</td></tr>\n";
           print "<tr><td>R2- Controlled_Count_CASH_Percent      </td><td> $Controlled_Count_CASH_Percent</td></tr>\n";
           print "<tr><td>S2- Controlled_Sale_CASH               </td><td> $Controlled_Sale_CASH</td></tr>\n";
           print "<tr><td>T2- Controlled_Sale_CASH_Percent       </td><td> $Controlled_Sale_CASH_Percent</td></tr>\n";
           print "<tr><td>U2- Legent_Count_CASH                  </td><td> $Legent_Count_CASH</td></tr>\n";
           print "<tr><td>V2- Legent_Count_CASH_Percent          </td><td> $Legent_Count_CASH_Percent</td></tr>\n";
           print "<tr><td>W2- Legend_Sale_CASH                   </td><td> $Legend_Sale_CASH</td></tr>\n";
           print "<tr><td>X2- Legend_Sale_CASH_Percent           </td><td> $Legend_Sale_CASH_Percent</td></tr>\n";
           print "</table>\n";
           print "<hr size=8 color=red>\n";
         }
      }
   } else {
   ...
   if(!$check) {
     print qq#<div class="page">#;
     print qq#<div class="page_header"><h3>$inYear RBS Averages - $pharmacy_string</h3></div><br />#;
   ...
   $Total_Counts{$key} =~ s/,//g;
   $TotalCount += $Total_Counts{$key};
#  -------------------
...
#  -------------------
   ...
   $TotalCount = commify($TotalCount);
   print qq#<tr><td style="text-align: left;">Total Script Count</td><td>$TotalCount</td><td>$SUM_Total_Counts{$key}</td><td>$REG_Total_Counts{$key}</td><td>$SIZ_Total_Counts{$key}</td></tr>#;
   ...
   if ( $debug ) {
     print qq#<tr bgcolor=yellow>#;
     print qq#<td style="text-align: left;">*** AMY ***<br>"% Controlled" for Total Script Count: I2/H1<br>Controlled_Count_All / Total_Count)<br></td>#;
     print qq#<td style="text-align: center;">$NCPDP</td>#;
     print qq#<td style="text-align: center;">SUM</td>#;
     print qq#<td style="text-align: center;">REG</td>#;
     print qq#<td style="text-align: center;">SIZ</td>#;
     print qq#</tr>#;
   }
   ...
   if ( $debug ) {
     print qq#<tr bgcolor=yellow>#;
     print qq#<td style="text-align: left;">*** AMY ***<br>"% Controlled" for Total Sale: K2/K1<br>Controlled_Sale_All / Total_Sale)<br></td>#;
     print qq#<td style="text-align: center;">$NCPDP</td>#;
     print qq#<td style="text-align: center;">SUM</td>#;
     print qq#<td style="text-align: center;">REG</td>#;
     print qq#<td style="text-align: center;">SIZ</td>#;
...
sub ncpa {
  ...
  print "<p>State: $state | Region: $region</p>" if ($debug);
  #########################################
  ...
  if ($ncpa_data_present > 0) {
    ...
    #print "<p>Class: $dcClasses{$NCPDP} | $ncpdps_for_rbs_avg</p>";
    #print "<p>rbsavg_count = $rbsavg_count</p>";
    ...
    ### Sales and Rebated Cost by year
      SELECT sum(Total_Brand_Revenue + Total_Generic_Revenue) as Sales, sum(Rebated_Brand_Cost + Rebated_Generic_Cost) as Rebated_Cost, financials_sales.amount as financials_sales, othersales.amount as Other_Sales, 
             financials_costs.amount as financials_costs, othercosts.amount as Other_Costs
        FROM (
          SELECT yearly.*, 
      ...
      LEFT JOIN (SELECT ncpdp, ncpa_category_number, truncate(sum(amount), 2) as amount FROM rbsreporting.financials WHERE ncpa_category_number LIKE '%101' && year = $YEAR GROUP BY ncpa_category_number, ncpdp) financials_sales
        ON (rebated.NCPDP = financials_sales.ncpdp)
      LEFT JOIN (SELECT ncpdp, ncpa_category_number, truncate(sum(amount), 2) as amount FROM rbsreporting.financials WHERE ncpa_category_number LIKE '%102' && year = $YEAR GROUP BY ncpa_category_number, ncpdp) othersales
        ON (rebated.NCPDP = othersales.ncpdp)
      LEFT JOIN (SELECT ncpdp, ncpa_category_number, truncate(sum(amount), 2) as amount FROM rbsreporting.financials WHERE ncpa_category_number LIKE '%201' && year = $YEAR GROUP BY ncpa_category_number, ncpdp) financials_costs
        ON (rebated.NCPDP = financials_costs.ncpdp)
      LEFT JOIN (SELECT ncpdp, ncpa_category_number, truncate(sum(amount), 2) as amount FROM rbsreporting.financials WHERE ncpa_category_number LIKE '%202' && year = $YEAR GROUP BY ncpa_category_number, ncpdp) othercosts
    ...
    if ($ncpa_data_present > 0) {
      ...
      if ( $sales =~ /^\s*$/ ) {
         ...
         if ( $debug ) {
            print "after getdatafrom_rbreporting.financials:<br\n";
            print "sales: $sales<br>\n";
            print "costs: $costs<br>\n";
            print "financials_sales: $financials_sales<br>\n";
            print "other_sales: $other_sales<br>\n";
            print "financials_costs: $financials_costs<br>\n";
            print "other_costs: $other_costs<br>\n";
         }
      }
    }
    
    #STOP REFACTORING "OTHER" VALUES - Per Monty/Amy 2/12/2015
    
    ### Refactor "Other Sales" and "Other Costs"
    #$other_sales = $financials_sales + $other_sales - $sales;
    #$other_costs = $financials_costs + $other_costs - $costs;
    
    ### START USING FINANCIAL SALES/COST - Per Monty/Amy 2/12/2015
    $sales = $financials_sales;
    $costs = $financials_costs;
    
    print "<p>Sales: $sales | Cost: $costs | Other Sales: $other_sales | Other Costs: $other_costs</p>" if ($debug);
    ###############################################################################################
    ...
    LEFT JOIN (SELECT 1 as JOINER, ncpa_category_number, truncate(sum(amount), 2) as amount 
    ...
    ### Refactor "Other Sales" and "Other Costs"
    #$rbsavg_other_sales = $rbsavg_financials_sales + $rbsavg_other_sales - $rbsavg_sales;
    #$rbsavg_other_costs = $rbsavg_financials_costs + $rbsavg_other_costs - $rbsavg_costs;
    
    ### START USING FINANCIAL SALES/COST - Per Monty/Amy 2/12/2015
    $rbsavg_sales = $rbsavg_financials_sales;
    $rbsavg_costs = $rbsavg_financials_costs;
    
    print "<p>Sales: $rbsavg_sales | Cost: $rbsavg_costs | Other Sales: $rbsavg_other_sales | Other Costs: $rbsavg_other_costs</p>" if ($debug);
    ###############################################################################################
    ...
    print "<p>Total Yearly Sales: $sales | Sales Category: $sales_category</p>" if ($debug);
    #########################################
    
    
    print qq#<div class="page">#;
    print qq#<div class="page_header"><h3>$YEAR NCPA Comparison - $pharmacy_string</h3></div><br />#;
  
    print qq#<table class="tableizer-table">\n#;
  
    $ncpa_table_header_row = "<tr><th>$nbsp</th><th>$pharmacy_string</th><th>Store %</th><th>RBS $rbs_avg_class<br />Average</th><th>NCPA<br />Average</th><th>$sales_category</th><th>$region</th></tr>\n";
    ...
    if ( $Jay_LTCs{$inNCPDP} ) {
       ...
       print "<tr><td>Total Sales</td><td>\$$all_sales_disp</td><td>100.0%</td><td>100.0%</td><td>100.0%</td><td>100.0%</td><td>100.0%</td></tr>\n";
    }
    ...
    #May not need these -------------------------------------#
    #$all_costs = $costs + $other_costs;
      #$all_costs_disp = commify($all_costs);
    #$rbsavg_all_costs = $rbsavg_costs + $rbsavg_other_costs;
    #--------------------------------------------------------#
    
    #Store $, Store %, RBS Avg, :: NCPA Avg, NCPA Top 25 Avg, Sales Category Avg, Location Avg
    
    ###Row 4, Rx Cost
    #--------------------------------------------------------#
    $rx_costs_disp = commify(sprintf "%.0f",$costs);
#   print "costs: $costs, sales: $sales<br>\n";
    ...
    $rbsavg_rxcosts = 0;
    if ($rbsavg_sales > 0) {
      #$rbsavg_rxcosts = sprintf "%.1f", (($rbsavg_costs/$rbsavg_all_sales)*100);
    ...
    if ( $Jay_LTCs{$inNCPDP} ) {
      ...
      if ( $ReportMonth != '2015-12-01' ) {
         print "<tr><td>Rx Costs</td><td>\$$rx_costs_disp</td><td>$rx_costs_percent_disp%</td><td>$rbsavg_rxcosts%</td><td>$ncpa_rx_costs%</td><td>$ncpa_sales_rx_costs%</td><td>$ncpa_location_rx_costs%</td></tr>\n"
      } else {
    ...
    if ( $Jay_LTCs{$inNCPDP} ) {
       # ltc LTC Pharmacy Found
#      print "<tr><td>All Other Costs</td><td>\$$other_costs_disp</td><td>$other_costs_percent_disp%</td><td>$rbsavg_ocosts%</td><td>-</td><td>-</td><td>-</td><td>-</td></tr>\n";
...
#      print "<tr><td>Total GP</td><td>\$$total_gp_disp</td><td>$total_gp_percent_disp%</td><td>$rbsavg_total_gp_percent_disp%</td><td>$ncpa_total_gp%</td><td>$ncpa_top25_total_gp%</td><td>$ncpa_sales_total_gp%</td><td>$ncpa_location_total_gp%</td></tr>\n";
    ...
    #$sql = "
    #SELECT ncpa_category, ncpa_category_number, sum(amount) as amount FROM rbsreporting.financials 
    #WHERE 
    #ncpdp = $NCPDP && 
    #year = $YEAR 
    #&& ncpa_category_number NOT IN (${YEAR}101, ${YEAR}102, ${YEAR}201, ${YEAR}202)
    ...
    LEFT JOIN (
      SELECT ncpdp, ncpa_category_number, sum(amount) as amount 
      FROM rbsreporting.financials 
      WHERE 
      ncpdp = $NCPDP && 
      year = ${YEAR}
...
#      print "<tr><td>Total Operating Exp.</td><td>\$$pharm_expense_exp_disp</td><td>$pharm_expense_percent_disp%</td><td>$rbsavg_expense_percent_disp%</td><td>$ncpa_average_exp%</td><td>$ncpa_top25_exp%</td><td>$ncpa_sales_exp%</td><td>$ncpa_location_exp%</td></tr>\n";
    ...
    if ( $Jay_LTCs{$inNCPDP} ) {
       if ( $ReportMonth != '2015-12-01' ) {
           # ltc LTC Pharmacy Found
    #      print "<tr><td><strong>Total Net Income</strong></td><td>\$$pharm_net_income</td><td>$pharm_net_percent%</td><td>$rbsavg_net_percent%</td><td>-</td><td>-</td><td>-</td><td>-</td></tr>\n";
           print "<tr><td><strong>Total Net Income</strong></td><td>\$$pharm_net_income</td><td>$pharm_net_percent%</td><td>$rbsavg_net_percent%</td><td>-</td><td>-</td><td>-</td></tr>\n";

       } else {
           print "<tr><td><strong>Total Net Income</strong></td><td>\$$pharm_net_income</td><td>$pharm_net_percent%</td><td>4.5%</td><td>-</td><td>-</td><td>-</td></tr>\n";
       }
    } else {
#      print "<tr><td><strong>Total Net Income</strong></td><td>\$$pharm_net_income</td><td>$pharm_net_percent%</td><td>$rbsavg_net_percent%</td><td>$ncpa_average_net%</td><td>$ncpa_top25_net%</td><td>$ncpa_sales_net%</td><td>$ncpa_location_net%</td></tr>\n";
       
       if ( $ReportMonth != '2015-12-01' ) {
           print "<tr><td><strong>Total Net Income</strong></td><td>\$$pharm_net_income</td><td>$pharm_net_percent%</td><td>$rbsavg_net_percent%</td><td>$ncpa_average_net%</td><td>$ncpa_sales_net%</td><td>$ncpa_location_net%</td></tr>\n";
       } else {
            print "<tr><td><strong>Total Net Income</strong></td><td>\$$pharm_net_income</td><td>$pharm_net_percent%</td><td>4.5%</td><td>$ncpa_average_net%</td><td>$ncpa_sales_net%</td><td>$ncpa_location_net%</td></tr>\n";
       }
    ...
    if ($countInventoryRows > 0) {
      ...
      print "<tr><th>$nbsp</th><th>&nbsp;</th><th>Store ($ymc)</th><th>RBS Average ($ymc)</th><th>NCPA<br />Average</th><th>NCPA Top<br />25 Average</th><th>$sales_category</th><th>$region</th></tr>\n";
...
#;
  ...
  if ($total != -20000) {
    ...
    if ($rbsavg > 2000299) {
      ...
      sum(amount)/($rbsavg_count) as amount 
      FROM rbsreporting.financials 
      WHERE 
      year = $year 
...
sub displayPatientInfo {
  ...
  my $section_title = "Patient Information - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
  ...
  for (my $lyear=$yearm2; $lyear<=$yearcur; $lyear++) {
    for (my $lmonth=1; $lmonth<=12; $lmonth++) {
      ...
      foreach $Pharmacy_ID (@suPH_IDs) { 
        ...
        $RepKey = "$inNCPDP##$lyear-$lmonth-01"; #Build key to retrieve data
    
        $Unique_Patients += $Rep_Unique_Patients{$RepKey};
        $Total_Scripts   += ($Rep_Total_Brand{$RepKey} + $Rep_Total_Generic{$RepKey});
     
        $Brand_Sales     += $Rep_Total_Brand_Revenue{$RepKey};
        $Generic_Sales   += $Rep_Total_Generic_Revenue{$RepKey};
        $Total_Sales     += ($Rep_Total_Brand_Revenue{$RepKey} + $Rep_Total_Generic_Revenue{$RepKey});
  ...
  $section_title = "Patient Information (continued) - $pharmacy_string";
  print qq#<div class="page">\n#;
  print qq#<div class="page_header"><h3>$section_title</h3></div>\n#;
...
sub displayClaimInfo {
  ...
  my $title = "New vs. Refill Claims - $pharmacy_string";
  my $id = "claiminfo";
...
\$(function () {
  ...
  if ($debug) {
    print "
    <hr />
    <p>New_Claim_Count: $New_Claim_Count</p>
    <p>New_Claim_Sales: $New_Claim_Sales</p>
    <p>New_Avg_Sale_Per_Script: $New_Avg_Sale_Per_Script</p>
    <hr />
    <p>Refill_Claim_Count: $Refill_Claim_Count</p>
    <p>Refill_Claim_Sales: $Refill_Claim_Sales</p>
    <p>Refill_Avg_Sale_Per_Script: $Refill_Avg_Sale_Per_Script</p>
    <hr />
    ";
  }
...
sub displayBGUtilization {
  ...
  my $title = "Brand/Generic Utilization - $pharmacy_string";
  my $id = "BGUtilization";
...
sub inventoryTurns {
  ...
  my $title = "Inventory Turns - $pharmacy_string";
  my $id    = "inventoryTurns";
  
  %Inventory_Turns = ();  

  my $sql = "
    SELECT NCPDP, Date, Inventory_Value, Inventory_Turns
      FROM $DBNAMERM.inventory_values
     WHERE 1=1 
        && (Pharmacy_ID IN ($suPH_IDs) || NCPDP = -1)
  ";
  ...
  $InvKey    = "$suPH_IDs##$yearcur-$sjmonth-01";
  $InvKeyLY  = "$suPH_IDs##$yearm1-$sjmonth-01";
  $InvKeyLYE = "$suPH_IDs##$yearm1-12-01";
...
sub get_GPI {
  ...
  print "sub get_GPI: Entry. NDC_Number: $NDC_Number<br>\n" if ($incdebug);
  ...
  #;
    ...
    print "sub get_GPI: $DBNAME.$TABLE - Number of rows found: $NumOfRows<br>\n" if ($incdebug);
  
    if ( $NumOfRows > 0 ) {
       while ( my @row = $sthLM->fetchrow_array() ) {
          ($NDC, $DRUGNAME, $GPI, $CONTROLLED_SUBSTANCE_CODE) = @row;
          print "Yo: NDC: $NDC, DRUGNAME: $DRUGNAME, GPI: $GPI, CONTROLLED_SUBSTANCE_CODE: $CONTROLLED_SUBSTANCE_CODE<br>\n" if ($incdebug);
       }
    }
    $sthLM->finish;
    $dbm->disconnect;
...
# print "<br>\n", "-"x120, "<br><br>\n\n" if ($incdebug);
  ...
  if ( $incdebug ) {
     print "sub get_GPI: exit. $DBNAME.$TABLE - GPI: $GPI, DRUGNAME: $DRUGNAME, CONTROLLED_SUBSTANCE_CODE: $CONTROLLED_SUBSTANCE_CODE<br>\n";
     print "-"x80, "<br>\n";
  }
...
# my $debug++;
  ...
  $pass++;
  $container = "${RptType}_containerClaims_$pass";
  $title = "\Q$title\E";	# jlh. 02/18/2016. This fixed the "disappearing" graph problem...

  print "sub doCSClaimsgraph. Entry. TYPE: $RptType<br>title: $title<br>\n" if ($debug);
  print "<hr>ClaimsString: $ClaimsString<hr>\n" if ($debug);
...
#;
  ...
  print "sub doCSClaimsgraph. Exit.<br>\n" if ($debug);
...
# my $debug++;
  ...
  $container = "${RptType}_containerDollars";
  $title = "\Q$title\E";	# jlh. 02/18/2016. This fixed the "disappearing" graph problem...
...
#;
  ...
  print "sub doCSDollarsgraph. Exit.<br>\n" if ($debug);
...
# my $debug++;
  ...
  print "sub getdatafrom_rbsreportingfinancials. Entry. NCPDP: $NCPDP<br>\n" if ($debug);
...
SELECT  FS.ncpdp,
 ...
 other_costs
FROM
(SELECT ncpdp, ncpa_category_number, format(sum(amount),2) as "financials_sales" FROM rbsreporting.financials WHERE ncpdp=$NCPDP && ncpa_category_number=2014101) FS,
(SELECT ncpdp, ncpa_category_number, format(sum(amount),2) as "other_sales"      FROM rbsreporting.financials WHERE ncpdp=$NCPDP && ncpa_category_number=2014102) OS,
(SELECT ncpdp, ncpa_category_number, format(sum(amount),2) as "financials_costs" FROM rbsreporting.financials WHERE ncpdp=$NCPDP && ncpa_category_number=2014201) FC,
(SELECT ncpdp, ncpa_category_number, format(sum(amount),2) as "other_costs"      FROM rbsreporting.financials WHERE ncpdp=$NCPDP && ncpa_category_number=2014202) OC
#;
  ...
  if ( $debug ) {
     print "sub getdatafrom_rbsreportingfinancials. Entry.<br>\n";
     print "Return: ($sales, $costs, $financials_sales, $other_sales, $financials_costs, $other_costs)<br>\n";
  }
...
$SUM_RowType,$SUM_Pharmacy_Name,$SUM_NCPDP,$SUM_Pharmacy_Type,$SUM_Location,$SUM_Size,$SUM_Total_Count,$SUM_Brand_Count,$SUM_Generic_Count,$SUM_Total_Sale,$SUM_Brand_Sale,$SUM_Generic_Sale,$SUM_Total_GM,$SUM_Brand_GM,$SUM_Generic_GM,$SUM_Total_GM_Percent,$SUM_Brand_GM_Percent,$SUM_Generic_GM_Percent,$SUM_Total_Sale_Per_Script,$SUM_Brand_Sale_Per_Script,$SUM_Generic_Sale_Per_Script,$SUM_Total_GM_Per_Script,$SUM_Brand_GM_Per_Script,$SUM_Generic_GM_Per_Script,$SUM_Unique_Patients,$SUM_Average_Unique_Patients,$SUM_Average_Scripts_Per_Unique_Patient,$SUM_Average_Sale_Per_Unique_Patient,$SUM_Average_GM_Per_Unique_Patient,$SUM_New_Claim_Count,$SUM_New_Claim_Sales,$SUM_Refill_Claim_Count,$SUM_Refill_Claim_Sales,$SUM_Controlled_Count_ALL,$SUM_Controlled_Count_ALL_Percent,$SUM_Controlled_Sale_ALL,$SUM_Controlled_Sale_ALL_Percent,$SUM_Legent_Count_ALL,$SUM_Legent_Count_ALL_Percent,$SUM_Legend_Sale_ALL,$SUM_Legend_Sale_ALL_Percent,$SUM_Controlled_Count_CASH,$SUM_Controlled_Count_CASH_Percent,$SUM_Controlled_Sale_CASH,$SUM_Controlled_Sale_CASH_Percent,$SUM_Legent_Count_CASH,$SUM_Legent_Count_CASH_Percent,$SUM_Legend_Sale_CASH,$SUM_Legend_Sale_CASH_Percent
       ...
       if ( $debug ) {
         print "<table border=1 width=50%>\n";
         print "<tr><th colspan=2>RowType = 'S' && Pharmacy_Type = '$Pharmacy_Type' && Location = 'ALL' && Size = 'ALL'</th></tr>\n";
         print "<tr><th width=65% align=left>Variable</th><th>Value</th>\n";
         print "<tr><td>SUM A1- key                                </td><td> $SUM_NCPDP</td></tr>\n";
         print "<tr><td>SUM B1- RowType                            </td><td> $SUM_RowType</td></tr>\n";
         print "<tr><td>SUM C1- Pharmacy_Name                      </td><td> $SUM_Pharmacy_Name</td></tr>\n";
         print "<tr><td>SUM D1- NCPDP                              </td><td> $SUM_NCPDP</td></tr>\n";
         print "<tr><td>SUM E1- Pharmacy_Type                      </td><td> $SUM_Pharmacy_Type</td></tr>\n";
         print "<tr><td>SUM F1- Location                           </td><td> $SUM_Location</td></tr>\n";
         print "<tr><td>SUM G1- Size                               </td><td> $SUM_Size</td></tr>\n";
         print "<tr><td>SUM H1- Total_Count                        </td><td> $SUM_Total_Count</td></tr>\n";
         print "<tr><td>SUM I1- Brand_Count                        </td><td> $SUM_Brand_Count</td></tr>\n";
         print "<tr><td>SUM J1- Generic_Count                      </td><td> $SUM_Generic_Count</td></tr>\n";
         print "<tr><td>SUM K1- Total_Sale                         </td><td> $SUM_Total_Sale</td></tr>\n";
         print "<tr><td>SUM L1- Brand_Sale                         </td><td> $SUM_Brand_Sale</td></tr>\n";
         print "<tr><td>SUM M1- Generic_Sale                       </td><td> $SUM_Generic_Sale</td></tr>\n";
         print "<tr><td>SUM N1- Total_GM                           </td><td> $SUM_Total_GM</td></tr>\n";
         print "<tr><td>SUM O1- Brand_GM                           </td><td> $SUM_Brand_GM</td></tr>\n";
         print "<tr><td>SUM P1- Generic_GM                         </td><td> $SUM_Generic_GM</td></tr>\n";
         print "<tr><td>SUM Q1- Total_GM_Percent                   </td><td> $SUM_Total_GM_Percent</td></tr>\n";
         print "<tr><td>SUM R1- Brand_GM_Percent                   </td><td> $SUM_Brand_GM_Percent</td></tr>\n";
         print "<tr><td>SUM S1- Generic_GM_Percent                 </td><td> $SUM_Generic_GM_Percent</td></tr>\n";
         print "<tr><td>SUM T1- Total_Sale_Per_Script              </td><td> $SUM_Total_Sale_Per_Script</td></tr>\n";
         print "<tr><td>SUM U1- Brand_Sale_Per_Script              </td><td> $SUM_Brand_Sale_Per_Script</td></tr>\n";
         print "<tr><td>SUM V1- Generic_Sale_Per_Script            </td><td> $SUM_Generic_Sale_Per_Script</td></tr>\n";
         print "<tr><td>SUM W1- Total_GM_Per_Script                </td><td> $SUM_Total_GM_Per_Script</td></tr>\n";
         print "<tr><td>SUM X1- Brand_GM_Per_Script                </td><td> $SUM_Brand_GM_Per_Script</td></tr>\n";
         print "<tr><td>SUM Y1- Generic_GM_Per_Script              </td><td> $SUM_Generic_GM_Per_Script</td></tr>\n";
         print "<tr><td>SUM Z1- Unique_Patients                    </td><td> $SUM_Unique_Patients</td></tr>\n";
         print "<tr><td>SUM A2- Average_Unique_Patients            </td><td> $SUM_Average_Unique_Patients</td></tr>\n";
         print "<tr><td>SUM B2- Average_Scripts_Per_Unique_Patient </td><td> $SUM_Average_Scripts_Per_Unique_Patient</td></tr>\n";
         print "<tr><td>SUM C2- Average_Sale_Per_Unique_Patient    </td><td> $SUM_Average_Sale_Per_Unique_Patient</td></tr>\n";
         print "<tr><td>SUM D2- Average_GM_Per_Unique_Patient      </td><td> $SUM_Average_GM_Per_Unique_Patient</td></tr>\n";
         print "<tr><td>SUM E2- New_Claim_Count                    </td><td> $SUM_New_Claim_Count</td></tr>\n";
         print "<tr><td>SUM F2- New_Claim_Sales                    </td><td> $SUM_New_Claim_Sales</td></tr>\n";
         print "<tr><td>SUM G2- Refill_Claim_Count                 </td><td> $SUM_Refill_Claim_Count</td></tr>\n";
         print "<tr><td>SUM H2- Refill_Claim_Sales                 </td><td> $SUM_Refill_Claim_Sales</td></tr>\n";
         print "<tr><td>SUM I2- Controlled_Count_ALL               </td><td> $SUM_Controlled_Count_ALL</td></tr>\n";
         print "<tr><td>SUM J2- Controlled_Count_ALL_Percent       </td><td> $SUM_Controlled_Count_ALL_Percent</td></tr>\n";
         print "<tr><td>SUM K2- Controlled_Sale_ALL                </td><td> $SUM_Controlled_Sale_ALL</td></tr>\n";
         print "<tr><td>SUM L2- Controlled_Sale_ALL_Percent        </td><td> $SUM_Controlled_Sale_ALL_Percent</td></tr>\n";
         print "<tr><td>SUM M2- Legent_Count_ALL                   </td><td> $SUM_Legent_Count_ALL</td></tr>\n";
         print "<tr><td>SUM N2- Legent_Count_ALL_Percent           </td><td> $SUM_Legent_Count_ALL_Percent</td></tr>\n";
         print "<tr><td>SUM O2- Legend_Sale_ALL                    </td><td> $SUM_Legend_Sale_ALL</td></tr>\n";
         print "<tr><td>SUM P2- Legend_Sale_ALL_Percent            </td><td> $SUM_Legend_Sale_ALL_Percent</td></tr>\n";
         print "<tr><td>SUM Q2- Controlled_Count_CASH              </td><td> $SUM_Controlled_Count_CASH</td></tr>\n";
         print "<tr><td>SUM R2- Controlled_Count_CASH_Percent      </td><td> $SUM_Controlled_Count_CASH_Percent</td></tr>\n";
         print "<tr><td>SUM S2- Controlled_Sale_CASH               </td><td> $SUM_Controlled_Sale_CASH</td></tr>\n";
         print "<tr><td>SUM T2- Controlled_Sale_CASH_Percent       </td><td> $SUM_Controlled_Sale_CASH_Percent</td></tr>\n";
         print "<tr><td>SUM U2- Legent_Count_CASH                  </td><td> $SUM_Legent_Count_CASH</td></tr>\n";
         print "<tr><td>SUM V2- Legent_Count_CASH_Percent          </td><td> $SUM_Legent_Count_CASH_Percent</td></tr>\n";
         print "<tr><td>SUM W2- Legend_Sale_CASH                   </td><td> $SUM_Legend_Sale_CASH</td></tr>\n";
         print "<tr><td>SUM X2- Legend_Sale_CASH_Percent           </td><td> $SUM_Legend_Sale_CASH_Percent</td></tr>\n";
         print "</table>\n";
         print "<hr size=8 color=red>\n";
       }
     }
...
$REG_RowType,$REG_Pharmacy_Name,$REG_NCPDP,$REG_Pharmacy_Type,$REG_Location,$REG_Size,$REG_Total_Count,$REG_Brand_Count,$REG_Generic_Count,$REG_Total_Sale,$REG_Brand_Sale,$REG_Generic_Sale,$REG_Total_GM,$REG_Brand_GM,$REG_Generic_GM,$REG_Total_GM_Percent,$REG_Brand_GM_Percent,$REG_Generic_GM_Percent,$REG_Total_Sale_Per_Script,$REG_Brand_Sale_Per_Script,$REG_Generic_Sale_Per_Script,$REG_Total_GM_Per_Script,$REG_Brand_GM_Per_Script,$REG_Generic_GM_Per_Script,$REG_Unique_Patients,$REG_Average_Unique_Patients,$REG_Average_Scripts_Per_Unique_Patient,$REG_Average_Sale_Per_Unique_Patient,$REG_Average_GM_Per_Unique_Patient,$REG_New_Claim_Count,$REG_New_Claim_Sales,$REG_Refill_Claim_Count,$REG_Refill_Claim_Sales,$REG_Controlled_Count_ALL,$REG_Controlled_Count_ALL_Percent,$REG_Controlled_Sale_ALL,$REG_Controlled_Sale_ALL_Percent,$REG_Legent_Count_ALL,$REG_Legent_Count_ALL_Percent,$REG_Legend_Sale_ALL,$REG_Legend_Sale_ALL_Percent,$REG_Controlled_Count_CASH,$REG_Controlled_Count_CASH_Percent,$REG_Controlled_Sale_CASH,$REG_Controlled_Sale_CASH_Percent,$REG_Legent_Count_CASH,$REG_Legent_Count_CASH_Percent,$REG_Legend_Sale_CASH,$REG_Legend_Sale_CASH_Percent
       ...
       if ( $debug ) {
         print "<table border=1 width=50%>\n";
         print "<tr><th colspan=2>RowType = 'S' && Pharmacy_Type = '$Pharmacy_Type' && Location = '$Location'</th></tr>\n";
         print "<tr><th width=65% align=left>Variable</th><th>Value</th>\n";
         print "<tr><td>REG A1- key                                </td><td> $REG_NCPDP</td></tr>\n";
         print "<tr><td>REG B1- RowType                            </td><td> $REG_RowType</td></tr>\n";
         print "<tr><td>REG C1- Pharmacy_Name                      </td><td> $REG_Pharmacy_Name</td></tr>\n";
         print "<tr><td>REG D1- NCPDP                              </td><td> $REG_NCPDP</td></tr>\n";
         print "<tr><td>REG E1- Pharmacy_Type                      </td><td> $REG_Pharmacy_Type</td></tr>\n";
         print "<tr><td>REG F1- Location                           </td><td> $REG_Location</td></tr>\n";
         print "<tr><td>REG G1- Size                               </td><td> $REG_Size</td></tr>\n";
         print "<tr><td>REG H1- Total_Count                        </td><td> $REG_Total_Count</td></tr>\n";
         print "<tr><td>REG I1- Brand_Count                        </td><td> $REG_Brand_Count</td></tr>\n";
         print "<tr><td>REG J1- Generic_Count                      </td><td> $REG_Generic_Count</td></tr>\n";
         print "<tr><td>REG K1- Total_Sale                         </td><td> $REG_Total_Sale</td></tr>\n";
         print "<tr><td>REG L1- Brand_Sale                         </td><td> $REG_Brand_Sale</td></tr>\n";
         print "<tr><td>REG M1- Generic_Sale                       </td><td> $REG_Generic_Sale</td></tr>\n";
         print "<tr><td>REG N1- Total_GM                           </td><td> $REG_Total_GM</td></tr>\n";
         print "<tr><td>REG O1- Brand_GM                           </td><td> $REG_Brand_GM</td></tr>\n";
         print "<tr><td>REG P1- Generic_GM                         </td><td> $REG_Generic_GM</td></tr>\n";
         print "<tr><td>REG Q1- Total_GM_Percent                   </td><td> $REG_Total_GM_Percent</td></tr>\n";
         print "<tr><td>REG R1- Brand_GM_Percent                   </td><td> $REG_Brand_GM_Percent</td></tr>\n";
         print "<tr><td>REG S1- Generic_GM_Percent                 </td><td> $REG_Generic_GM_Percent</td></tr>\n";
         print "<tr><td>REG T1- Total_Sale_Per_Script              </td><td> $REG_Total_Sale_Per_Script</td></tr>\n";
         print "<tr><td>REG U1- Brand_Sale_Per_Script              </td><td> $REG_Brand_Sale_Per_Script</td></tr>\n";
         print "<tr><td>REG V1- Generic_Sale_Per_Script            </td><td> $REG_Generic_Sale_Per_Script</td></tr>\n";
         print "<tr><td>REG W1- Total_GM_Per_Script                </td><td> $REG_Total_GM_Per_Script</td></tr>\n";
         print "<tr><td>REG X1- Brand_GM_Per_Script                </td><td> $REG_Brand_GM_Per_Script</td></tr>\n";
         print "<tr><td>REG Y1- Generic_GM_Per_Script              </td><td> $REG_Generic_GM_Per_Script</td></tr>\n";
         print "<tr><td>REG Z1- Unique_Patients                    </td><td> $REG_Unique_Patients</td></tr>\n";
         print "<tr><td>REG A2- Average_Unique_Patients            </td><td> $REG_Average_Unique_Patients</td></tr>\n";
         print "<tr><td>REG B2- Average_Scripts_Per_Unique_Patient </td><td> $REG_Average_Scripts_Per_Unique_Patient</td></tr>\n";
         print "<tr><td>REG C2- Average_Sale_Per_Unique_Patient    </td><td> $REG_Average_Sale_Per_Unique_Patient</td></tr>\n";
         print "<tr><td>REG D2- Average_GM_Per_Unique_Patient      </td><td> $REG_Average_GM_Per_Unique_Patient</td></tr>\n";
         print "<tr><td>REG E2- New_Claim_Count                    </td><td> $REG_New_Claim_Count</td></tr>\n";
         print "<tr><td>REG F2- New_Claim_Sales                    </td><td> $REG_New_Claim_Sales</td></tr>\n";
         print "<tr><td>REG G2- Refill_Claim_Count                 </td><td> $REG_Refill_Claim_Count</td></tr>\n";
         print "<tr><td>REG H2- Refill_Claim_Sales                 </td><td> $REG_Refill_Claim_Sales</td></tr>\n";
         print "<tr><td>REG I2- Controlled_Count_ALL               </td><td> $REG_Controlled_Count_ALL</td></tr>\n";
         print "<tr><td>REG J2- Controlled_Count_ALL_Percent       </td><td> $REG_Controlled_Count_ALL_Percent</td></tr>\n";
         print "<tr><td>REG K2- Controlled_Sale_ALL                </td><td> $REG_Controlled_Sale_ALL</td></tr>\n";
         print "<tr><td>REG L2- Controlled_Sale_ALL_Percent        </td><td> $REG_Controlled_Sale_ALL_Percent</td></tr>\n";
         print "<tr><td>REG M2- Legent_Count_ALL                   </td><td> $REG_Legent_Count_ALL</td></tr>\n";
         print "<tr><td>REG N2- Legent_Count_ALL_Percent           </td><td> $REG_Legent_Count_ALL_Percent</td></tr>\n";
         print "<tr><td>REG O2- Legend_Sale_ALL                    </td><td> $REG_Legend_Sale_ALL</td></tr>\n";
         print "<tr><td>REG P2- Legend_Sale_ALL_Percent            </td><td> $REG_Legend_Sale_ALL_Percent</td></tr>\n";
         print "<tr><td>REG Q2- Controlled_Count_CASH              </td><td> $REG_Controlled_Count_CASH</td></tr>\n";
         print "<tr><td>REG R2- Controlled_Count_CASH_Percent      </td><td> $REG_Controlled_Count_CASH_Percent</td></tr>\n";
         print "<tr><td>REG S2- Controlled_Sale_CASH               </td><td> $REG_Controlled_Sale_CASH</td></tr>\n";
         print "<tr><td>REG T2- Controlled_Sale_CASH_Percent       </td><td> $REG_Controlled_Sale_CASH_Percent</td></tr>\n";
         print "<tr><td>REG U2- Legent_Count_CASH                  </td><td> $REG_Legent_Count_CASH</td></tr>\n";
         print "<tr><td>REG V2- Legent_Count_CASH_Percent          </td><td> $REG_Legent_Count_CASH_Percent</td></tr>\n";
         print "<tr><td>REG W2- Legend_Sale_CASH                   </td><td> $REG_Legend_Sale_CASH</td></tr>\n";
         print "<tr><td>REG X2- Legend_Sale_CASH_Percent           </td><td> $REG_Legend_Sale_CASH_Percent</td></tr>\n";
         print "</table>\n";
         print "<hr size=8 color=red>\n";
       }
     }
...
$SIZ_RowType,$SIZ_Pharmacy_Name,$SIZ_NCPDP,$SIZ_Pharmacy_Type,$SIZ_Location,$SIZ_Size,$SIZ_Total_Count,$SIZ_Brand_Count,$SIZ_Generic_Count,$SIZ_Total_Sale,$SIZ_Brand_Sale,$SIZ_Generic_Sale,$SIZ_Total_GM,$SIZ_Brand_GM,$SIZ_Generic_GM,$SIZ_Total_GM_Percent,$SIZ_Brand_GM_Percent,$SIZ_Generic_GM_Percent,$SIZ_Total_Sale_Per_Script,$SIZ_Brand_Sale_Per_Script,$SIZ_Generic_Sale_Per_Script,$SIZ_Total_GM_Per_Script,$SIZ_Brand_GM_Per_Script,$SIZ_Generic_GM_Per_Script,$SIZ_Unique_Patients,$SIZ_Average_Unique_Patients,$SIZ_Average_Scripts_Per_Unique_Patient,$SIZ_Average_Sale_Per_Unique_Patient,$SIZ_Average_GM_Per_Unique_Patient,$SIZ_New_Claim_Count,$SIZ_New_Claim_Sales,$SIZ_Refill_Claim_Count,$SIZ_Refill_Claim_Sales,$SIZ_Controlled_Count_ALL,$SIZ_Controlled_Count_ALL_Percent,$SIZ_Controlled_Sale_ALL,$SIZ_Controlled_Sale_ALL_Percent,$SIZ_Legent_Count_ALL,$SIZ_Legent_Count_ALL_Percent,$SIZ_Legend_Sale_ALL,$SIZ_Legend_Sale_ALL_Percent,$SIZ_Controlled_Count_CASH,$SIZ_Controlled_Count_CASH_Percent,$SIZ_Controlled_Sale_CASH,$SIZ_Controlled_Sale_CASH_Percent,$SIZ_Legent_Count_CASH,$SIZ_Legent_Count_CASH_Percent,$SIZ_Legend_Sale_CASH,$SIZ_Legend_Sale_CASH_Percent
       ...
       if ( $debug ) {
         print "<table border=1 width=50%>\n";
         print "<tr><th colspan=2>RowType = 'S' && Pharmacy_Type = '$Pharmacy_Type' && Location = 'ALL' && Size = '$Size'</th></tr>\n";
         print "<tr><th width=65% align=left>Variable</th><th>Value</th>\n";
         print "<tr><td>SIZ A1- key                                </td><td> $SIZ_NCPDP</td></tr>\n";
         print "<tr><td>SIZ B1- RowType                            </td><td> $SIZ_RowType</td></tr>\n";
         print "<tr><td>SIZ C1- Pharmacy_Name                      </td><td> $SIZ_Pharmacy_Name</td></tr>\n";
         print "<tr><td>SIZ D1- NCPDP                              </td><td> $SIZ_NCPDP</td></tr>\n";
         print "<tr><td>SIZ E1- Pharmacy_Type                      </td><td> $SIZ_Pharmacy_Type</td></tr>\n";
         print "<tr><td>SIZ F1- Location                           </td><td> $SIZ_Location</td></tr>\n";
         print "<tr><td>SIZ G1- Size                               </td><td> $SIZ_Size</td></tr>\n";
         print "<tr><td>SIZ H1- Total_Count                        </td><td> $SIZ_Total_Count</td></tr>\n";
         print "<tr><td>SIZ I1- Brand_Count                        </td><td> $SIZ_Brand_Count</td></tr>\n";
         print "<tr><td>SIZ J1- Generic_Count                      </td><td> $SIZ_Generic_Count</td></tr>\n";
         print "<tr><td>SIZ K1- Total_Sale                         </td><td> $SIZ_Total_Sale</td></tr>\n";
         print "<tr><td>SIZ L1- Brand_Sale                         </td><td> $SIZ_Brand_Sale</td></tr>\n";
         print "<tr><td>SIZ M1- Generic_Sale                       </td><td> $SIZ_Generic_Sale</td></tr>\n";
         print "<tr><td>SIZ N1- Total_GM                           </td><td> $SIZ_Total_GM</td></tr>\n";
         print "<tr><td>SIZ O1- Brand_GM                           </td><td> $SIZ_Brand_GM</td></tr>\n";
         print "<tr><td>SIZ P1- Generic_GM                         </td><td> $SIZ_Generic_GM</td></tr>\n";
         print "<tr><td>SIZ Q1- Total_GM_Percent                   </td><td> $SIZ_Total_GM_Percent</td></tr>\n";
         print "<tr><td>SIZ R1- Brand_GM_Percent                   </td><td> $SIZ_Brand_GM_Percent</td></tr>\n";
         print "<tr><td>SIZ S1- Generic_GM_Percent                 </td><td> $SIZ_Generic_GM_Percent</td></tr>\n";
         print "<tr><td>SIZ T1- Total_Sale_Per_Script              </td><td> $SIZ_Total_Sale_Per_Script</td></tr>\n";
         print "<tr><td>SIZ U1- Brand_Sale_Per_Script              </td><td> $SIZ_Brand_Sale_Per_Script</td></tr>\n";
         print "<tr><td>SIZ V1- Generic_Sale_Per_Script            </td><td> $SIZ_Generic_Sale_Per_Script</td></tr>\n";
         print "<tr><td>SIZ W1- Total_GM_Per_Script                </td><td> $SIZ_Total_GM_Per_Script</td></tr>\n";
         print "<tr><td>SIZ X1- Brand_GM_Per_Script                </td><td> $SIZ_Brand_GM_Per_Script</td></tr>\n";
         print "<tr><td>SIZ Y1- Generic_GM_Per_Script              </td><td> $SIZ_Generic_GM_Per_Script</td></tr>\n";
         print "<tr><td>SIZ Z1- Unique_Patients                    </td><td> $SIZ_Unique_Patients</td></tr>\n";
         print "<tr><td>SIZ A2- Average_Unique_Patients            </td><td> $SIZ_Average_Unique_Patients</td></tr>\n";
         print "<tr><td>SIZ B2- Average_Scripts_Per_Unique_Patient </td><td> $SIZ_Average_Scripts_Per_Unique_Patient</td></tr>\n";
         print "<tr><td>SIZ C2- Average_Sale_Per_Unique_Patient    </td><td> $SIZ_Average_Sale_Per_Unique_Patient</td></tr>\n";
         print "<tr><td>SIZ D2- Average_GM_Per_Unique_Patient      </td><td> $SIZ_Average_GM_Per_Unique_Patient</td></tr>\n";
         print "<tr><td>SIZ E2- New_Claim_Count                    </td><td> $SIZ_New_Claim_Count</td></tr>\n";
         print "<tr><td>SIZ F2- New_Claim_Sales                    </td><td> $SIZ_New_Claim_Sales</td></tr>\n";
         print "<tr><td>SIZ G2- Refill_Claim_Count                 </td><td> $SIZ_Refill_Claim_Count</td></tr>\n";
         print "<tr><td>SIZ H2- Refill_Claim_Sales                 </td><td> $SIZ_Refill_Claim_Sales</td></tr>\n";
         print "<tr><td>SIZ I2- Controlled_Count_ALL               </td><td> $SIZ_Controlled_Count_ALL</td></tr>\n";
         print "<tr><td>SIZ J2- Controlled_Count_ALL_Percent       </td><td> $SIZ_Controlled_Count_ALL_Percent</td></tr>\n";
         print "<tr><td>SIZ K2- Controlled_Sale_ALL                </td><td> $SIZ_Controlled_Sale_ALL</td></tr>\n";
         print "<tr><td>SIZ L2- Controlled_Sale_ALL_Percent        </td><td> $SIZ_Controlled_Sale_ALL_Percent</td></tr>\n";
         print "<tr><td>SIZ M2- Legent_Count_ALL                   </td><td> $SIZ_Legent_Count_ALL</td></tr>\n";
         print "<tr><td>SIZ N2- Legent_Count_ALL_Percent           </td><td> $SIZ_Legent_Count_ALL_Percent</td></tr>\n";
         print "<tr><td>SIZ O2- Legend_Sale_ALL                    </td><td> $SIZ_Legend_Sale_ALL</td></tr>\n";
         print "<tr><td>SIZ P2- Legend_Sale_ALL_Percent            </td><td> $SIZ_Legend_Sale_ALL_Percent</td></tr>\n";
         print "<tr><td>SIZ Q2- Controlled_Count_CASH              </td><td> $SIZ_Controlled_Count_CASH</td></tr>\n";
         print "<tr><td>SIZ R2- Controlled_Count_CASH_Percent      </td><td> $SIZ_Controlled_Count_CASH_Percent</td></tr>\n";
         print "<tr><td>SIZ S2- Controlled_Sale_CASH               </td><td> $SIZ_Controlled_Sale_CASH</td></tr>\n";
         print "<tr><td>SIZ T2- Controlled_Sale_CASH_Percent       </td><td> $SIZ_Controlled_Sale_CASH_Percent</td></tr>\n";
         print "<tr><td>SIZ U2- Legent_Count_CASH                  </td><td> $SIZ_Legent_Count_CASH</td></tr>\n";
         print "<tr><td>SIZ V2- Legent_Count_CASH_Percent          </td><td> $SIZ_Legent_Count_CASH_Percent</td></tr>\n";
         print "<tr><td>SIZ W2- Legend_Sale_CASH                   </td><td> $SIZ_Legend_Sale_CASH</td></tr>\n";
         print "<tr><td>SIZ X2- Legend_Sale_CASH_Percent           </td><td> $SIZ_Legend_Sale_CASH_Percent</td></tr>\n";
         print "</table>\n";
         print "<hr size=8 color=red>\n";
       }
     }
...
sub get_consolidated_names {
  if ($ptype ne 'ALL') {
    my $sql = "
      SELECT Consolidated_Name 
        FROM $db_rbs.$tbl_cnames
       WHERE 1=1 
          && Pharmacy_ID IN ($suPH_IDs)
    ";
  
    $sthit  = $dbx->prepare("$sql");
    $sthit->execute;
    $cname = $sthit->fetchrow();
  }
  else {
    $cname = 'ALL';
  }
