...
sub SalesByPayer {
  ...
  if ($sbp_data_present > 0) {
    ...
    if ($SBPNumOfRows > 0) {
      ...
      print "<tr><th>Plan</th><th>Rx Count</th><th>GDR</th><th>GER</th><th>Sales</th><th>% of Sales</th><th>Sale/ Script</th><th>Avg. Days Supply</th></tr>";
      while ( my @row = $getSBPdata->fetchrow_array() ) {
        ...
        print "<tr><td style=\"text-align: left;\">$plan</td><td>$count_disp</td><td>$gdr_percent%</td><td>$ger_percent%</td><td>\$$sales</td><td>$percent%</td><td>\$$sale_per_script</td><td>$avg_day_supply</td></tr>";
        $shown_count   += $count;
      ...
      FROM $DBNAMERM.sales_by_payer_tds
      WHERE NCPDP = $NCPDP
      && Year = $jyear
      && Qtr_YTD = $jqtr
      ";
      ...
      #Total Row
      print "<tr><td style=\"text-align: left;\">Totals (YTD)</td><td>$total_count</td><td>$total_gdr_percent%</td><td>$total_ger_percent%</td><td>\$$total_rx_sales</td><td>$total_percent%</td><td>\$$total_sale_per_script</td><td>---</td></tr>";
      ...
      #Total Row - Last Year
      print "<tr><td style=\"text-align: left;\">Prior Year</td><td>$total_count_hist</td><td>$total_gdr_percent_hist%</td><td>---</td><td>\$$total_rx_sales_hist</td><td>---</td><td>\$$total_sale_per_script_hist</td><td>---</td></tr>";  
