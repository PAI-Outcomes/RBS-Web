...
my $email   = 'RBS@Outcomes.com';
my $program = 'Outcomes RBS';
...
sub displayLetUsKnow {
  ...
  print qq#<tr><td>Mon-Fri</td><td>8:30am - 5:00pm CST</td></tr>\n#;
  print qq#<tr><td>Sat-Sun</td><td>Closed</td></tr>\n#;
  print qq#<tr><td colspan=2><h2>Closed on the following holidays:</h2></td><tr>\n#;
  print qq#<tr><td colspan=2><i>Martin Luther King Jr. Day, Memorial Day, Independence Day, Labor Day, Veterans Day, Thanksgiving Day, Day After Thanksgiving, Christmas Eve, Christmas Day, New Year's Eve, and New Year's Day</i></td></tr>\n#;
  print qq#</table>\n#;
}
